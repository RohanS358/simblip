...
function DialogContent({
  ...
  /** 'modal': centered zoom+fade (default — correct for a floating card).
   *  'sheet': edge-to-edge full-bleed content (e.g. a mobile full-screen
   *  view) slides up from the bottom instead of zooming from center, since
   *  it isn't a floating card anchored to a trigger point. */
  variant?: 'modal' | 'sheet'
}) {
  return (
