...
### Phase B — Digital completions (S4) ~small
...
### Phase C — Measurement & analysis layer (S1 + S3) ~medium
...
### Phase D — Fields & charged particles (S2 electrostatics + EM) ~medium
...
### Phase E — Optics engine (S2 optics) ~large, new solver
...
### Phase F — Thermal solver (S2 heat) ~medium
...
### Phase G — Machines (S3 back half) ~medium/large
...
### Phase H — Quantum & wave demos (S2 modern physics) ~small/medium
